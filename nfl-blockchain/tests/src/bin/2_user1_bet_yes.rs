...
fn main() {
    println!("Demo script 2: User 1 mints YES/NO tokens and sells all minted NO tokens.");
    println!("User 1 spends 4 SOL to mint the tokens, and gains 2 SOL from selling NO tokens.");
    println!("-------------\n");
    ...
    println!("Setpu client as User 1, User 1 address: {}", payer.pubkey());
    ...
    let wager_amount = 4_000_000_000; // 4 SOL
    ...
    println!("   [OK] Minted {} YES/NO pairs (4 SOL wagered)", wager_amount);
    ...
    println!("Collateral: {}", collateral_acc.amount);
    println!("User 1 has successfully bet YES on the outcome!");
       
    println!("If another user wants to execute a buy, they must use User1's collateral ID:");
